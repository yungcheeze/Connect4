...
/**
 * Class used to represent minimiser node in minimax search-tree
 */
public class MinNode implements Node {
   ...
   private NodeType nodeType;
    ...
    public MinNode(double alpha, double beta, List<Integer> moves, int[]remainingMoves, int branchingFactor) {
    ...
    public boolean setValue(double value) {
        ...
        this.value = Math.min(value, beta);
    ...
    public Node generateChild() {
        ...
        if (nextMove >= branchingFactor)
            ...
            Node childNode = new MaxNode(alpha, beta, childMoves, childRemainingMoves, branchingFactor);
